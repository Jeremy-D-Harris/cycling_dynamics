function f = TCID50_inputoutput_allmodels_MOI_negloglikelihood_wDIP(y, newdata_TCID50, TCID50_noise, WT_mois, DI_mois, pars, eps,Ncells,which_model)
    ...
    for kk=1:n_treatments
        ...
        if isnan(these_data)~=1
            if isnan(this_WT_moi)~=1
                ...
                TCID50_model = Get_TCID50_allmodels_MOI_wDIP(this_WT_moi,this_DI_moi, pars, y, eps,Ncells,which_model);
